...
//PROVIDED
    public static void main(String[] args) {
        System.out.println("VENDING TESTER");
        VendingMachine1 chaChing = new VendingMachine1();
        chaChing.run();
    }
}
...
class VendingMachine1 {
    ...
    //PROVIDED
    private Dispenser1 snackMachine;
    private Coinbox1 moneyBox;

    //PROVIDED
    public VendingMachine1() {
        snackMachine = new Dispenser1();
        moneyBox = new Coinbox1(0, 3, 3);
    }
...
class Product1 {
     ...
     */
    public Product1(String n, double p, int q){
        this.price = p;
        this.quantity = q;
        this.name = n;
    }
...
class Coinbox1 {
    ...
    //PROVIDED
    public Coinbox1(int Q, int D, int N){
        this.numQ = Q;
        this.numD = D;
        this.numN = N;
        this.amount = 0;
...
class Dispenser1 {
    ...
    public void setUpDispenser(){
        ...
        if(numItems < items.length){
            ...
            items[numItems] = new Product1(name, price, quantity);
